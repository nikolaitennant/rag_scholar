...
<b>ℹ️ This assistant uses only your uploaded docs (for RAG) and preloaded context.</b>
<ul>
  <li>Supported: PDF, TXT, DOC/DOCX, PPTX, CSV, PNG/JPG.</li>
  <li>It will not invent info—if it’s not in your docs, you’ll be told.</li>
</ul>
</div>
""", unsafe_allow_html=True)
