...
class RetrievalService:
    ...
    async def retrieve(
        ...
        use_hybrid = (
            ...
            else self.settings.use_hybrid_search
        )
    ...
    async def _hybrid_retrieve(
        ...
        if not bm25_index:
            ...
            return await self._vector_retrieve(
                query, vector_store, selected_files, k
            )
    ...
    async def _get_vector_store(self, collection: str) -> Optional[FAISS]:
    ...
    async def _get_bm25_index(self, collection: str) -> Optional[BM25Okapi]:
